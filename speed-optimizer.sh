...
if ! grep -q "tmpfs /var/log" /etc/fstab; then
    ...
    if ! mountpoint -q /var/log; then
        ...
        mount /var/log || echo -e "\033[1;31m[!] Failed to mount /var/log as tmpfs\033[0m"
    fi
fi

echo -e "\033[1;33m[~] Tuning Kernel Parameters (via /etc/sysctl.d/99-megassh.conf)...\033[0m"
